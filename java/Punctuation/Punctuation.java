...
public class Punctuation
{
	...
	public void getPunctuationWords(String sentence)
	{
		...
		{
			currentChar = sentence.charAt(currentWordIndex);
			currentWordLength++;
			
			if (currentChar == ' ' && checkForPunctuation(sentence.substring((currentWordIndex-currentWordLength+1),currentWordIndex)))
			{
				printWords(sentence.substring((currentWordIndex-currentWordLength+1),currentWordIndex));
				currentWordLength = 0; 
			}
		}
	}
	...
	public boolean checkForPunctuation(String word)
	{
		...
		return ((int)lastSymbol<48 || ((int)lastSymbol>57 && (int)lastSymbol<65) || ((int)lastSymbol>90 && (int)lastSymbol<97) || (int)lastSymbol>122);
	}
	
	public void printWords(String punctuationWord)
	{
		System.out.println(punctuationWord);
	}
}
